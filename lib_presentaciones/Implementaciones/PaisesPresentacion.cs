...
namespace lib_presentaciones.Implementaciones
{
    ...
    {
        private IPaisesComunicacion? iComunicacion = null;

        public PaisesPresentacion(IPaisesComunicacion iComunicacion)
        {
        ...
        public async Task<List<Paises>> Buscar(Paises entidad, string tipo)
        {
            var lista = new List<Paises>();
            var datos = new Dictionary<string, object>();
