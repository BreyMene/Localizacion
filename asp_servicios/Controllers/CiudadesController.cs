...
namespace asp_servicios.Controllers
{
    ...
    {
        private string Tabla = "Ciudades";
        private ICiudadesAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;
        private IAuditoriasAplicacion? Auditoria = null;

        public CiudadesController(ICiudadesAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Ciudades>(
